...
function Header(props){
    return(
      ...
      <div className="font-bold text-lg lg:text-2xl flex"><Link to="/favStudent">Favourites</Link><p className=" bg-white rounded-full text-black ml-1.5  px-2">{props.favStudentLenght}</p></div>
     </div>
        </>
    )
}
